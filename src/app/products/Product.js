    ...
    const { refetch } = useQuery({
        ...
        queryFn: async () => {
            try {
                ...
                const cates = await axiosPublic.get(`/api/categories`);
...

            {
                isLoading ? (
                    ...
                    <div className="relative w-full bg-gray-100 p-4">
                        ...
                        <div ref={scrollRef} className="flex overflow-x-auto rounded-lg whitespace-nowrap space-x-4 scrollbar-hide scroll-smooth px-8">
                    ...
                    isLoading ? (
                        ...
                        <div className="mt-4 grid grid-cols-4 gap-4">
                            {products?.map((product, index) => (
                                <Link href={`/sprods/${product?._id}`} key={product._id}>
